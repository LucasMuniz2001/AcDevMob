...
import control.CalculadoraImc;	
	...
	public class CalculadoraImcTests {
		...
		public void testeAdultoObesidadeGrau1LimiteInferior() {
			Assert.assertEquals("Obesidade grau 1", calc.calcularImc(1.6124, 78, 20, "masculino"));
			
		}
		
		@Test
		public void testeAdultoObesidadeGrau1LimiteSuperior() {
			Assert.assertEquals("Obesidade grau 1", calc.calcularImc(1.6127, 91, 20, "feminino"));
			
		}
		
		@Test
		public void testeAdultoObesidadeGrau2LimiteInferior() {
			Assert.assertEquals("Obesidade grau 2", calc.calcularImc(1.6212, 92, 20, "masculino"));
			
		}
		
		@Test
		public void testeAdultoObesidadeGrau2LimiteSuperior() {
			Assert.assertEquals("Obesidade grau 2", calc.calcularImc(1.629, 106, 20, "feminino"));
			
		}
		
		@Test
		public void testeAdultoObesidadeGrau3Limite() {
			Assert.assertEquals("Obesidade grau 3", calc.calcularImc(1.6278, 106, 20, "masculino"));
		...
		@Test
		public void testeIdosoFObesidadeGrau1LimiteInferior() {
			Assert.assertEquals("Obesidade grau 1", calc.calcularImc(1.65, 88, 70, "feminino"));
			
		}
		
		@Test
		public void testeIdosoFObesidadeGrau1LimiteSuperior() {
			Assert.assertEquals("Obesidade grau 1", calc.calcularImc(1.6192, 97, 70, "feminino"));
			
		}
		
		@Test
		public void testeIdosoFObesidadeGrau2LimiteInferior() {
			Assert.assertEquals("Obesidade grau 2", calc.calcularImc(1.615, 97, 70, "feminino"));
			
		}
		@Test
		public void testeIdosoFObesidadeGrau2LimiteSuperior() {
			Assert.assertEquals("Obesidade grau 2", calc.calcularImc(1.6277, 111, 70, "feminino"));
			
		}
		
		@Test
		public void testeIdosoFObesidadeGrau3Limite() {
			Assert.assertEquals("Obesidade grau 3", calc.calcularImc(1.6547, 115, 70, "feminino"));
		...
		@Test
		public void testeIdosoMObesidadeGrau1LimiteInferior() {
			Assert.assertEquals("Obesidade grau 1", calc.calcularImc(1.62, 79, 70, "masculino"));
			
		}
		
		@Test
		public void testeIdosoMObesidadeGrau1LimiteSuperior() {
			Assert.assertEquals("Obesidade grau 1", calc.calcularImc(1.6476, 95, 70, "masculino"));
			
		}
		
		@Test
		public void testeIdosoMObesidadeGrau2LimiteInferior() {
			Assert.assertEquals("Obesidade grau 2", calc.calcularImc(1.6451, 95, 70, "masculino"));
			
		}
		@Test
		public void testeIdosoMObesidadeGrau2LimiteSuperior() {
			Assert.assertEquals("Obesidade grau 2", calc.calcularImc(1.63, 106, 70, "masculino"));
			
		}
		
		@Test
		public void testeIdosoMObesidadeGrau3Limite() {
			Assert.assertEquals("Obesidade grau 3", calc.calcularImc(1.7392, 121, 70, "masculino"));
